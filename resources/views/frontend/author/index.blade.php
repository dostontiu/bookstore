    ...
    <section class="parallax-window" data-parallax="scroll" data-image-src="{{asset('frontend/img/home_bg_1.jpg')}}" data-natural-width="1400" data-natural-height="470">
        <div class="parallax-content-1">
            <div class="animated fadeInDown">
                <h1>Sharqshunoslik instituti</h1>
                <p>Kitoblar va ilmiy adabiyotlarni o'qing - Bu bo'limda o'quv qo'llanmalar, badiiy va ijodiy ishlar, shu bilan birga ta'limiy-ma'rifiy matеriallar jamlangan.</p>
            </div>
        </div>
    </section>
    <!-- End section -->
        ...
        <div class="container margin_60">
            <div class="row">
                <aside class="col-lg-3 col-md-3">
                    <h5 class="text-center" id="tools">Category</h5>
                            ...
                            <div class="strip_all_tour_list wow fadeIn" data-wow-delay="0.1s">
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-sm-4">
                                        <div class="ribbon_3 popular"><span>{{ ($book->author_id==1)?'ommabop':'yangi' }}</span>
                                        </div>
                                        <div class="wishlist">
                                        ...
                                        <div class="img_list">
                                            <a href="{{route('book.index')}}/{{$book->id}}"><img src="{{asset('images')}}/{{$book->photo}}" alt="Image">
                                                <div class="short_info"><i class="icon_set_1_icon-4"></i>{{$book->author->name}} </div>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-2">
                                        <div class="price_list">
                                            <div><sup></sup>{{$book->cost}}<span class="normal_price_list">{{$book->discount.'%'}}</span><small>*one</small>
                                                <h4>Uz</h4>
